...
require_once APP_EXTENDCODE_PATH . '/Zend/Db/Adapter/Abstract.php';

/**
 * @see Zend_Db_Adapter_Abstract
 */
require_once APP_EXTENDCODE_PATH . '/Zend/Db/Select.php';

/**
 * @see Zend_Db
 */
require_once APP_EXTENDCODE_PATH . '/Zend/Db.php';
...
abstract class Zend_Db_Table_Abstract
{
    ...
    protected static function _setupAdapter($db)
    {
        ...
        if (is_string($db)) {
            require_once APP_EXTENDCODE_PATH . '/Zend/Registry.php';
            $db = Zend_Registry::get($db);
        }
        if (!$db instanceof Zend_Db_Adapter_Abstract) {
            require_once APP_EXTENDCODE_PATH . '/Zend/Db/Table/Exception.php';
    ...
    protected function _setupPrimaryKey()
    {
        if (!$this->_primary) {
            ...
            if(! empty($this->_metadata)) {
                ...
                Modern_Api_Core::getLogger()->warn(__METHOD__.'::'.__LINE__." No table found");
                return false;
            }
    ...
    {
        require_once APP_EXTENDCODE_PATH . '/Zend/Db/Table/Select.php';
    ...
    public function fetchAll($where = null, $order = null, $count = null, $offset = null)
    {
        ...
        if (!class_exists($this->_rowsetClass)) {
            require_once APP_EXTENDCODE_PATH . '/Zend/Loader.php';
