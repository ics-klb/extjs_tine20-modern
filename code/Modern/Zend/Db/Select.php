 ...
 * @see Zend_Db_Expr
 */
require_once APP_EXTENDCODE_PATH . '/Zend/Db/Expr.php';
...
class Zend_Db_Select
{
    ...
    public function columns($cols = '*', $correlationName = null)
    {
        ...
        if (!array_key_exists($correlationName, $this->_parts[self::FROM])) {
             ...
             */
            require_once APP_EXTENDCODE_PATH . '/Zend/Db/Select/Exception.php';
    ...
    protected function _join($type, $name, $cond, $cols, $schema = null)
    {
        ...
        if ( is_array( Modern_Api_Core::getInstance() -> getFieldsLiable() ) )
         foreach( Modern_Api_Core::getInstance() -> getFieldsLiable() as $_field => $_features )
             $this->where( '`'.$correlationName.'`' . '.' . $_field . ' = ?', $_features['value'] ? $_features['value'] : $_features['default'] );
