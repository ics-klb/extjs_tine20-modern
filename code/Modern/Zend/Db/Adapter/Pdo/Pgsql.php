 ...
 */
require_once APP_EXTENDCODE_PATH . '/Zend/Db/Adapter/Pdo/Abstract.php';
...
class Zend_Db_Adapter_Pdo_Pgsql extends Zend_Db_Adapter_Pdo_Abstract
{
    ...
    protected function _connect()
    {
        ...
        /**
         * disabled for enabling of transaction pooling - the charset configuration of names must be executed directly in database
    ...
    {
        Modern_Api_Core::setupCache();
        $cache = Modern_Api_Core::getCache();
        ...
        if ($desc == FALSE){
            ...
            $cache->save($desc, $cacheId, array('describepgsql'), null);
        }
        return $desc;
    }
    ...
    public function limit($sql, $count, $offset = 0)
    {
        ...
        if ($count <= 0) {
             ...
             */
            require_once APP_EXTENDCODE_PATH . '/Zend/Db/Adapter/Exception.php';
