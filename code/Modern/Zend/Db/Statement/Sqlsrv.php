 ...
 */
require_once APP_EXTENDCODE_PATH . '/Zend/Db/Statement.php';

/**
 * Moderns for Microsoft SQL Server Driver for PHP
 *
 * @category   Zend
 * @package    Zend_Db
 * @subpackage Statement
...
class Zend_Db_Statement_Sqlsrv extends Zend_Db_Statement
{
    ...
    protected function _prepare($sql)
    {
        ...
        if (!$this->_stmt) {
            require_once APP_EXTENDCODE_PATH . '/Zend/Db/Statement/Sqlsrv/Exception.php';
