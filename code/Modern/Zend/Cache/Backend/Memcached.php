 ...
 */
require_once 'Zend/Cache/Backend/ModernInterface.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Cache_Backend_Memcached extends Zend_Cache_Backend implements Zend_Cache_Backend_ModernInterface
{
    /**
     * Default Values
     */
    ...
    {
        $mems = $this->_memcache->getModernStats();
