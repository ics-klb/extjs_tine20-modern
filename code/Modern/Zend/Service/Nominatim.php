...
class Zend_Service_Nominatim
{
    ...
    public function search()
    {
        ...
        if (Modern_Api_Core::isLogLevel(Zend_Log::DEBUG)) Modern_Api_Core::getLogger()->debug(__METHOD__ . '::' . __LINE__ . ' Connecting to Nominatim with uri ' . $this->_httpClient->getUri(true));
