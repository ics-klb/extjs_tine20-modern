 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Modern_Scheduler_Task implements Zend_Modern_Scheduler_Task_Interface
{
    ...
    /** @var array Array of Zend_Modern_Scheduler_Task_Rule_Abstract objects */
     ...
     * 
     * @param  array $options
     * @return Zend_Modern_Scheduler_Task
     */
    public static function getTask(array $options = array())
    {
        return new Zend_Modern_Scheduler_Task($options);
    }
...
//          $controller->setRouter($router);
    ...
    {
        $this->_rules[$type] = new Zend_Modern_Scheduler_Task_Rule($type, $rule);
        return $this;
    }
    
    /**
     * 
     * @return Array of Zend_Modern_Scheduler_Task_Rule objects
     */
