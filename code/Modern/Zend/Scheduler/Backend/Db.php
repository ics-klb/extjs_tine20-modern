 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Modern_Scheduler_Backend_Db extends Zend_Modern_Scheduler_Backend_Abstract
{
    /**
    ...
    public function saveQueue($tasks = array())
    {
        ...
        $transactionId = Modern_Api_TransactionManager::getInstance()->startTransaction($db);
        ...
        try {
            ...
            Modern_Api_TransactionManager::getInstance()->commitTransaction($transactionId);
            
        } catch (Exception $e) {
            Modern_Api_TransactionManager::getInstance()->rollBack();
            throw $e;
        }
    }
