 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Modern_Scheduler_Backend_File extends Zend_Modern_Scheduler_Backend_Abstract
{
    /** @var string Filename */
    protected $_filename = '';
    ...
    public function setFilename($filename)
    {
        ...
        if (!is_writable($filename)) {
            throw new Zend_Modern_Scheduler_Exception("Cannot write to file '{$filename}'");
        }
    ...
    public function saveQueue($tasks = array())
    {
        if (empty($this->_filename)) {
            throw new Zend_Modern_Scheduler_Exception('Filename must be set in backend');
        }
