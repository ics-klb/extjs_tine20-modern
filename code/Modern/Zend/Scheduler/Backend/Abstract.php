 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class Zend_Modern_Scheduler_Backend_Abstract
{
    /**
     * @var string Task Class
     */
    protected $_taskClass = 'Zend_Modern_Scheduler_Task';
    ...
    public function setOptions(array $options)
    {
        foreach ($options as $option => $value) {
            ...
            if (!method_exists($this, $method)) {
                throw new Zend_Modern_Scheduler_Exception("Option '{$option}' does not exist");
            }
            $this->{$method}($value);
        }
    }
