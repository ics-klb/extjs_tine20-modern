...
Ext.define('Ext.App', {
    ...
    addMessage : function(status, msg) {
        ...
        Ext.DomHelper.append(this.msgCt, {html:this.buildMessageBox(status, Ext.String.format.apply(String, Array.prototype.slice.call(arguments, 1)))}, true).slideIn('t').pause(delay).ghost("t", {remove:true});
    },
