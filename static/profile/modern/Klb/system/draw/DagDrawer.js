...
Ext.define('DagDrawer', {
    extend: 'Klb.system.draw.Component',
    xtype: 'dagdrawer',
 ...
 *
 * Parameters: surface - the Klb.system.draw canvas, allShapes - the list of all
 ...
 *
 * Parameters: surface - the Klb.system.draw canvas, nodes - the nodes :
 ...
 *
 * Parameters: surface - the Klb.system.draw canvas, nodes - the list of nodes, settings -
 ...
 *
 * Parameters: surface - the Klb.system.draw canvas, node - the node, x - the shape
...
DagDrawer.prototype.buildNode = function(surface, node, x, settings) {
    ...
    var sprites = Ext.create('Klb.system.draw.CompositeSprite', {
        surface: surface,
    });
 ...
 *
 * Parameters: surface - the Klb.system.draw canvas, height - the height of the arrow, color -
 ...
 *
 * Parameters: surface - the Klb.system.draw canvas, obj1 - source shape, obj2 - destination
...
DagDrawer.prototype.drawEdge = function(surface, obj1, obj2, line, bg) {
    ...
    var set = Ext.create('Klb.system.draw.CompositeSprite', {
        surface: surface
    });
