 ...
 * @class       Klb.system.UserRegistration
 * @extends     Klb.abstract.Window
 */
Ext.define('Klb.system.UserRegistration', {
    ...
    initComponent: function() {
        ...
        Klb.system.UserRegistration.superclass.initComponent.call(this);
    ...
    getSuggestedUsername: function() {
        Klb.system.Ajax.request({
            ...
            params: {
                method: 'Api_UserRegistration.suggestUsername',
    ...
    cardNames: function () {
        ...
        var accountFirstName = new Ext.form.field.Text({
        ...
        var accountLastName = new Ext.form.field.Text({
        ...
        var accountLoginName = new Ext.form.field.Text({
        ...
        var accountEmailAddress = new Ext.form.field.Text({
        ...
        var cardNamesPanel = new Ext.form.Panel({
            id: 'cardNames',
            layout: 'form',
...
/*                                if ( this.registrationData.accountLoginName ) {
                                    Klb.system.Ajax.request({
                                        url: KlbSys.requestUrl ,
                                        params: {
                                            method: 'Api_UserRegistration.checkUniqueUsername',
                ...
                'finish': {
                    fn: function() {
                        Klb.system.Ajax.request({
                            url: KlbSys.requestUrl ,
                            params: {
                                method: 'Api_UserRegistration.registerUser',
                                regData: this.registrationData
                            },
