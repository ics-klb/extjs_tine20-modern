...
Ext.ns('Klb.system.data', 'Klb.system.data.schemaProc');
...
Ext.onReady(function() {
    Klb.system.Ajax.request({
        ...
        success: function(response) {
            var db = openDatabase('tine20local', '0.1', 'Modern 3.0 Local Stuff', 1024*1024);
            
            
            db.transaction(function(t) {
                var xml = response.responseXML;
                var schema = Klb.system.data.schemaProc.xmlReader.getSchema(xml);
                var stmts = Klb.system.data.schemaProc.sqlGenerator.getCreateStmts(schema);
 ...
 * 
 */
Klb.system.data.schemaProc.sqlGenerator = {
