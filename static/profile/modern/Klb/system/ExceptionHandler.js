 ...
 * @class Klb.system.ExceptionHandler
 * @singleton
 * 
 ...
 */
Klb.system.ExceptionHandler = function() {
     ...
     * 
     * @param {Klb.Exception|Object} exception
     */
    var handleRequestException = function(exception, callback, callbackScope) {
        ...
        Klb.Logger.debug('Klb.system.ExceptionHandler::handleRequestException -> Exception:');
        ...
        switch (exception.code) {
                ...
                Ext.MessageBox.show(Ext.apply(defaults, {
                    ...
                    fn: function() {
                        ...
                        if (redirect && redirect != '') {
                            window.location = Klb.App.Api.registry.get('redirectUrl');
                        } else {
            ...
            // Use this error code for unique constraint violation
            case 23505:
                Ext.MessageBox.show(Ext.apply(defaults, {
                    title: _('Duplicated list.'), 
                    msg: _('A list with this name already exists. Please, choose another one.')
                }));
                break;
            ...
            case 510:
                ...
                Ext.MessageBox.show(Ext.apply(defaults, {
                    ...
                    msg: _('Connection lost, please check your network!') + message
                }));                
                break;
        ...
        if (Klb.system.configManager.get('automaticBugreports') && ! Klb.system.exceptionDlg) {
            Klb.Logger.debug('Klb.system.ExceptionHandler::handleRequestException -> Activate non-interacive exception dialog.');
            Klb.system.exceptionDlg = new Klb.system.ExceptionDialog({
                exception: exception,
                nonInteractive: true,
                listeners: {
