...
Ext.ns('Klb.system.widgets', 'Klb.system.widgets.relation');

/**
 * @namespace   Klb.system.widgets.relation
 * @class       Klb.system.widgets.relation.FilterModel
 * @extends     Klb.system.widgets.grid.FilterModel
 * 
 * @todo CARE FOR SHEET DESTRUCTON!
 * @todo CARE FOR OPERATOR CHANGE
 */
Ext.define('Klb.system.widgets.relation.FilterModel', {
    ...
    initComponent: function() {
        ...
        this.relatedModelStore = this.fieldStore = new Klb.system.data.JsonStore({
        ...
        Klb.system.widgets.relation.FilterModel.superclass.initComponent.call(this);
...
Klb.system.statics.Filters.add( 'apibase.relation', 'Klb.system.widgets.relation.FilterModel');
