...
Klb.system.widgets.customfields.Field = {
     ...
     * get the form field 
     * 
     * @param {Klb.system.Application} app the application the customfield belongs to
     * @param {Klb.system.data.Record} cfConfig customfields config record
     * @param {Object} config additional field config
     * @param {Klb.system.widgets.dialog.EditDialog} editDialog the calling editdialog - just needed if record must not link itself
     * 
     * @return {Ext.form.Field}
     */
    get: function (app, cfConfig, config, editDialog) {
        Klb.Logger.debug(cfConfig);
