 ...
 * @class       Klb.system.widgets.dialog.MultipleEditResultSummary
 * @extends     Ext.form.Panel
 */

Ext.define('Klb.system.widgets.dialog.MultipleEditResultSummary', {
    ...
    initComponent: function() {
        ...
        Klb.system.widgets.dialog.MultipleEditResultSummary.superclass.initComponent.call(this);
    },
    ...
    onRender : function(ct, position) {
        Klb.system.widgets.dialog.MultipleEditResultSummary.superclass.onRender.call(this, ct, position);
    ...
    getFormItems: function() {
        ...
        var summary =  Ext.String.format( (allrecs>1) ? _('You edited {0} {1}.') : _('You edited {0} {1}.'), allrecs, rn);
        summary += '<br />';
        rn = (this.response.totalcount>1) ? this.i18nRecordsName : this.i18nRecordName;
        summary +=  Ext.String.format( (this.response.totalcount>1) ? _('{0} {1} have been updated properly.') : _('{0} {1} has been updated properly.'), this.response.totalcount, rn);
        summary += '<br />';
        rn = (this.response.failcount>1) ? this.i18nRecordsName : this.i18nRecordName;
        summary +=  Ext.String.format( (this.response.failcount>1) ? _('{0} {1} have invalid data after updating. These {1} have not been changed.') : _('{0} {1} has invalid data after updating. This {1} has not been changed.'), this.response.failcount, rn);
...
Klb.system.widgets.dialog.MultipleEditResultSummary.openWindow = function (config) {
    var window = Klb.WindowFactory.getWindow({
        width: 600,
        height: 450,
        modal: true,
        title: _('Summary'),
        contentPanelConstructor: 'Klb.system.widgets.dialog.MultipleEditResultSummary',
