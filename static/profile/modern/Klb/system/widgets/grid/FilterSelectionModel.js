 ...
 * @class       Klb.system.widgets.grid.FilterSelectionModel
 * @extends     Ext.grid.RowSelectionModel
 */
Ext.define('Klb.system.widgets.grid.FilterSelectionModel', {
    ...
    /**
     * @cfg {Klb.system.widgets.grid.GridPanel}
     */
    gridPanel: null,
    ...
    selectAll: function(onlyPage) {
        ...
        Klb.system.widgets.grid.FilterSelectionModel.superclass.selectAll.call(this);
    },
    ...
    onRefresh : function(){
        ...
        Klb.system.widgets.grid.FilterSelectionModel.superclass.onRefresh.call(this);
    },
    ...
    onRemove : function(v, index, r){
        this.clearSelections(true);
        Klb.system.widgets.grid.FilterSelectionModel.superclass.onRemove.call(this, v, index, r);
    },
    ...
    deselectRow : function(index, preventViewNotify) {
        ...
        Klb.system.widgets.grid.FilterSelectionModel.superclass.deselectRow.call(this, index, preventViewNotify);
    },
        ...
        if (this.isFilterSelect) {
            ...
            this.store.each(function(record) {
                ...
                if (this.isSelected(index)) {
                    ...
                    this.selectByPosition(index, true);
                }
            }, this);
    ...
    getFilterOfRowSelection: function() {
        ...
        this.each(function(record) {
            ids.push(record.id);
            if (record.data.container_id !== undefined){
                containers.push(record.data.container_id.id);
            }
        });
        return [{field: idProperty, operator: 'in', value: ids},{field: 'container_id', operator: 'in', value: containers}];
    }
