 ...
 *              @see Klb.system.widgets.grid.PickerFilter
 */
Ext.ns('Klb.system.widgets.grid');

/**
 * @namespace   Klb.system.widgets.grid
 * @class       Klb.system.widgets.grid.FilterModelMultiSelect
 * @extends     Klb.system.widgets.grid.FilterModel
 * 
 * @author      Philipp Schuele <p.schuele@metaways.de>
 */
Ext.define('Klb.system.widgets.grid.FilterModelMultiSelect', {
    ...
    initComponent: function() {
        ...
        Klb.system.widgets.grid.FilterModelMultiSelect.superclass.initComponent.call(this);
    },
    ...
    valueRenderer: function(filter, el) {
        var value = new Klb.system.widgets.grid.FilterModelMultiSelectValueField(Ext.apply({
            app: this.app,
            filter: filter,
...
/**
 * @namespace   Klb.system.widgets.grid
 * @class       Klb.system.widgets.grid.FilterModelMultiSelectValueField
 * @extends     Ext.ux.form.LayerCombo
 * 
 * @author      Philipp Schuele <p.schuele@metaways.de>
 */

Ext.define('Klb.system.widgets.grid.FilterModelMultiSelectValueField', {
    ...
    initComponent: function() {
        ...
        Klb.system.widgets.grid.FilterModelMultiSelectValueField.superclass.initComponent.call(this);
    },
    ...
    setValue: function(value) {
        ...
        if (this.xtype == 'checkbox' && this.valueStore ) {
            this.valueStore.each(function(record) {
...
Klb.system.statics.Filters.add('apibase.multiselect', 'Klb.system.widgets.grid.FilterModelMultiSelect');
