 ...
 * @class     Klb.system.widgets.tree.FilterPlugin
 * @extends   Klb.system.widgets.grid.FilterPlugin
 */
Ext.define('Klb.system.widgets.tree.FilterPlugin', {
    extend: 'Klb.system.widgets.grid.FilterPlugin',
    /**
    ...
    getFilter: function() {
        var filter = {field: this.field},
            ...
            selection = multiSelection ? sm.getSelectedNodes() : sm.getSelection();
        ...
        Ext.each(selection, function(node) {
            if (node) {
                values.push(node.get(this.nodeAttributeField) );
            }
        }, this);
