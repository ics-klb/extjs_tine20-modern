...
Ext.apply(Klb.system, {
    ...
    logf : function(format, arg1, arg2, etc){
        Klb.system.log(Ext.String.format.apply(String, arguments));
    },
    ...
    dump : function(o){
        if(typeof o == 'string' || typeof o == 'number' || typeof o == 'undefined' || Ext.isDate(o)){
            ...
            Klb.system.log('Unknown return type');
        }else if(Ext.isArray(o)){
            Klb.system.log('['+o.join(',')+']');
        }else{
            var b = ["{\n"];
            for(var key in o){
                var to = typeof o[key];
    ...
    timeEnd : function(name, printResults){
        ...
        if(printResults !== false){
            Klb.system.log('Timer ' + (name == "def" ? v : name + ": " + v));
        }
        return v;
    }
});
    ...
    evalScript : function(){
        ...
        if(this.trapBox.getValue()){
            try{
                ...
                Klb.system.log(e.message || e.descript);
            }
        }else{
            var rt = eval(s);
            Ext.dump(rt === undefined? '(no return)' : rt);
...
Ext.define('Ext.debug.DomTree', {
    ...
    initComponent : function(){
        ...
        */
        ...
        this.loader = new Ext.data.TreeStore();
        this.loader.load = function(n, cb){
            ...
            for(var i = 0, c; c = cn[i]; i++){
                ...
                if(c.nodeType == 1){
                    ...
                    n.appendChild(new Ext.data.TreeStore({
        ...
        this.root = this.setRootNode(new Ext.data.TreeStore('Ext'));
...
Ext.define('Ext.debug.ComponentNodeUI', {
    extend: 'Ext.data.TreeStoreUI',
...
Ext.define('Ext.debug.ComponentInspector', {
    extend: 'Ext.tree.Panel',
    ...
    initComponent : function(){
        ...
        this.root = this.setRootNode(new Ext.data.TreeStore({
            text: 'Ext Components',
    ...
    createNode: function(n,c) {
        ...
        return n.appendChild(new Ext.data.TreeStore({
...
Ext.define('Ext.debug.ComponentInfoPanel', {
    extend: 'Ext.panel.Panel',
...
Ext.define('Ext.debug.ColumnNodeUI', {
    extend: 'Ext.data.TreeStoreUI',
...
Ext.define('Ext.debug.ObjectInspector', {
    extend: 'Ext.tree.Panel',
    ...
    createNode: function(o) {
        return this.root.appendChild(new Ext.data.TreeStore({
            name: o,
...
Ext.define('Ext.debug.StoreInspector', {
    extend: 'Ext.tree.Panel',
    enableDD:false ,
    lines:false,
    rootVisible:false,
...
Ext.debug.HtmlNode = function(){
    ...
    Ext.extend(HtmlNode, Ext.data.TreeStore, {
        cls: 'x-tree-noicon',
        preventHScroll: true,
        ...
        onExpand : function(){
            if(!this.closeNode && this.parentNode){
                this.closeNode = this.parentNode.insertBefore(new Ext.data.TreeStore({
                    text:'&lt;/' + this.tagName + '&gt;',
                    cls: 'x-tree-noicon'
                }), this.nextSibling);
