...
Ext.define('Klb.system.ux.desktop.Sidebar', {
    ...
    constructor: function (config) { 
      ...
      this.start = 0;
      this.pageSize = parseInt((Ext.dom.getViewHeight() - taskbarEl.getHeight() - this.topAndBottomMargin) / (this.gHeight + this.gMargin));
  ...
  GadgetCloseTool: function(sideBar) {  
