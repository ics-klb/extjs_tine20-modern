 ...
 */
 ...
 /*
 * @class Klb.system.ux.desktop.Router
 ...
 */
Ext.define('Klb.system.ux.desktop.Router', {
    singleton: true,
    ...
    routeMatcher: function(app, route, rules) {
        ...
        if (!routeObj.controller && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[Klb.system.ux.desktop.Router] Config 'controller' can't be undefined", route, rules);
        }
    
        if (!routeObj.action && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[Klb.system.ux.desktop.Router] Config 'action' can't be undefined", route, rules);
        }
        //</debug>
    ...
    dispatch: function(token, route, params) {
        ...
        if (!controller[route.action] && Ext.isDefined(Ext.global.console)) {
            Ext.global.console.error("[Klb.system.ux.desktop.Router] Controller action not found ", route.controller, route.action);
            return false;
        }
        //</debug>
        ...
        if (!classMgr.get(controllerFullName)) {
            ...
            if (!classMgr.get(controllerFullName)) {
                ...
                if (Ext.isDefined(Ext.global.console)) {
                    Ext.global.console.warn("[Klb.system.ux.desktop.Router] Controller not found ", route.controller);
                }
                return false;
            }
    ...
    Ext.override(Ext.app.Application, {
        ...
        onBeforeLaunch: function() {
            ...
            if(this.enableRouter){
                Klb.system.ux.desktop.Router.init(this);
            }
        }
    });
});