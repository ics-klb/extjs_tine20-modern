...
Ext.define('Klb.system.ux.desktop.Video', {
    ...
    initComponent: function () {
        ...
        if (me.fallbackHTML) {
            ...
            fallback = _("Your browser does not support HTML5 Video.");

            if (Ext.isChrome) {
                fallback += _('Upgrade Chrome.');
            } else if (Ext.isGecko) {
                fallback += _('Upgrade to Firefox 3.5 or newer.');
            } else {
