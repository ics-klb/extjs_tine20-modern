...
Ext.extend(Ext.ux.tree.CheckboxSelectionModel, Ext.util.Observable, {
     ...
     * @param {Ext.data.TreeStore} node The node to check
     * @return {Boolean}
     */
    ...
    /**
     * Select a node.
     * @param {Ext.data.TreeStore} node The node to select
     * @return {TExt.data.TreeStore} The selected node
     */
    ...
    /**
     * Deselect a node.
     * @param {Ext.data.TreeStore} node The node to unselect
     */
    ...
    onKeyDown : Ext.data.TreeModel.prototype.onKeyDown,

    selectNext : Ext.data.TreeModel.prototype.selectNext,

    selectPrevious : Ext.data.TreeModel.prototype.selectPrevious
});
