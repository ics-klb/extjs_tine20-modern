...
var cm = new Ext.grid.ColumnManager([{
       header: 'Foo',
       ...
    },
    checkColumn
...
Ext.ux.grid.CheckColumn.prototype ={
    ...
    onMouseDown : function(e, t){
        if(Ext.fly(t).hasClass(this.createId())){
            e.stopEvent();
            var index = this.grid.getView().findItemByChild(t);
    ...
    renderer : function(v, p, record){
        ...
        return  Ext.String.format('<div class="x-grid3-check-col{0} {1}">&#160;</div>', v ? '-on' : '', this.createId());
    },
