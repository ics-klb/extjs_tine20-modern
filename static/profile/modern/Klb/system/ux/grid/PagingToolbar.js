...
Ext.define('Ext.ux.grid.PagingToolbar', {
    ...
    renderSelHelper: function() {
        this.deselectBtn = new Ext.Action({
            ...
            scope: this,
            handler: function() {this.selModel.clearSelections();}
        });
...
//        this.addSeparator();
        ...
        this.selModel.on('selectionchange', this.updateSelHelper, this);
    ...
    getSelHelperText: function(domain) {
        ...
        return  Ext.String.format(this.selHelperText[domain], num);
    }    
});
