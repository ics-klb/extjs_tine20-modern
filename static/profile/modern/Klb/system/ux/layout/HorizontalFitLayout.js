 ...
 * layout:'hfit' {@link Ext.Container.layout.type#layout} config, and should generally not need to be created directly via 
 * the new keyword.</p>
...
//Ext.Container.layout.type['hfit'] = Ext.ux.layout.HorizontalFitLayout;
