 ...
 * @author www.steinarmyhre.com
 * @constructor
 * Identical to Ext.button.Button and/or Ext.Toolbar.Button except that enableToggle is true by default.
 * @param (Object/Array) config A config object
 */

Ext.define('Ext.ux.ButtonLockedToggle', {
    extend: 'Ext.button.Button',
    xtype: 'btnlockedtoggle',
    enableToggle: true,
