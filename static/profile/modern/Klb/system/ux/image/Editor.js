...
Ext.define('Ext.ux.image.Editor',{
    extend: 'Ext.Window',
    ...
    getUrl: function(options) {
        ...
        var urlImg = new Ext.ux.util.ImageURL({
            id: this.record.get('id'),
            width: 500,
            height: 600,
            ratiomode: 1
        });
        if ( !this.record.get('tempFile') ) {
            urlImg.application = this.record.get('application');
            urlImg.location = this.record.get('locationid');
        }
...
//			params: {'action': 'create_temp_image', 'image': this.image},
        ...
        Ext.ux.image.Editor.superclass.initComponent.call(this);
    },
    ...
    afterHide: function() {
        ...
        Ext.ux.image.Editor.superclass.afterHide.call(this);
    }
});
