...
Ext.ux.DatePickerWeekPlugin.prototype = {
    ...
    init: function(picker) {
        ...
        picker.getRowEl = this.getRowEl.bind(picker);
        picker.selectWeek = this.selectWeek.bind(picker);
        picker.clearSelection = this.clearSelection.bind(picker);
        picker.onWkCellOver = this.onWkCellOver.bind(picker);
        picker.onWkCellOut = this.onWkCellOut.bind(picker);
    },
    ...
    handleDateClick: function(e) {
        ...
        if (target) {
            ...
            // set new date value
            var value = Ext.Date.parse(row.firstChild.firstChild.firstChild.firstChild.id.split(':')[1], 'Y-m-d');
            this.setValue(value);
